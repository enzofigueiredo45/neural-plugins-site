...
async function sendOrderConfirmationEmail({ checkoutId, email, products, amountTotal, currency }, env = process.env) {
  ...
  const accessMessage = hasAssistedDelivery
    ? "Seu pedido está registrado. A entrega assistida seguirá a modalidade informada para o item. Para proteger a compra, o acesso fica na biblioteca da conta com e-mail verificado."
    : "Seu pedido está registrado. Para proteger a compra, o acesso e as instruções ficam na biblioteca da conta com e-mail verificado.";
  return sendEmail({
    to: email,
